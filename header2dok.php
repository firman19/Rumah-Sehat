  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="masukdokter.php">BERANDA</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="jawabpasien.php">JAWAB PASIEN</a>
        </li>
        <li class="nav-item">
    ...
    <ul class="navbar-nav mr-auto float-right">
      <div class="dropdown show">
            <a class="btn btn-primary dropdown-toggle" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> AKUN </a>
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">            
              <a class="dropdown-item" href="akundokter.php">Jadwal Saya</a>
              <a class="dropdown-item" href="#">Edit Akun</a>
              <a class="dropdown-item" href="logoutdok.php">Keluar</a>
            </div>
          </div>
